...
describe('Subtle Social Connect Links (Instagram, Community, LinkedIn)', () => {
    ...
    const indexPath = fs.existsSync(path.join(rootDir, 'dist', 'index.html'))
    ...
    it('2. script.js implements initGlobalSocialLinks with valid official URLs', () => {
        ...
        assert.ok(scriptJs.includes('path-join-us'), 'script.js must contain official community link');
    ...
    it('3. index.html includes social connect bar and dropdown links', () => {
        ...
        assert.ok(indexHtml.includes('path-join-us'), 'index.html must link to community');
